...
CREATE TABLE `entries` (
  ...
  `07_count_drinks` enum('never','almost-never','sort-time','half-time','most-time','almost-always','always','skip') DEFAULT NULL,
  `07_set_number_drinks` enum('never','almost-never','sort-time','half-time','most-time','almost-always','always','skip') DEFAULT NULL,
  `07_eat_before` enum('never','almost-never','sort-time','half-time','most-time','almost-always','always','skip') DEFAULT NULL,
  `07_space_drinks_out` enum('never','almost-never','sort-time','half-time','most-time','almost-always','always','skip') DEFAULT NULL,
  `07_alternate_drinks` enum('never','almost-never','sort-time','half-time','most-time','almost-always','always','skip') DEFAULT NULL,
  `07_drink_for_quality` enum('never','almost-never','sort-time','half-time','most-time','almost-always','always','skip') DEFAULT NULL,
  `07_avoid_drinking_games` enum('never','almost-never','sort-time','half-time','most-time','almost-always','always','skip') DEFAULT NULL,
  `07_have_a_reliable_driver` enum('never','almost-never','sort-time','half-time','most-time','almost-always','always','skip') DEFAULT NULL,
  `07_preplan_transportation` enum('never','almost-never','sort-time','half-time','most-time','almost-always','always','skip') DEFAULT NULL,
  `07_dst_protection` enum('never','almost-never','sort-time','half-time','most-time','almost-always','always','skip') DEFAULT NULL,
  `07_watch_out_for_each_other` enum('never','almost-never','sort-time','half-time','most-time','almost-always','always','skip') DEFAULT NULL,
