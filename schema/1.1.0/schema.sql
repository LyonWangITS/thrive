...
CREATE TABLE `entries` (
  ...
  `01_first_pet` varchar(255) NOT NULL DEFAULT '',
  `01_first_concert` varchar(255) NOT NULL DEFAULT '',
  `01_mother_letters` varchar(2) NOT NULL DEFAULT '',
  `01_phone_digits` int(2) NOT NULL,
  ...
  `04_difficult_to_limit` enum('never', 'rarely', 'sometimes', 'often', 'always', 'skip') DEFAULT NULL,
  `04_start_drinking_after_deciding_not_to` enum('never', 'rarely', 'sometimes', 'often', 'always', 'skip') DEFAULT NULL,
  `04_end_up_drinking_more` enum('never', 'rarely', 'sometimes', 'often', 'always', 'skip') DEFAULT NULL,
  `04_cut_down_drinking` enum('never', 'rarely', 'sometimes', 'often', 'always', 'skip') DEFAULT NULL,
  `04_drink_when_causing_problems` enum('never', 'rarely', 'sometimes', 'often', 'always', 'skip') DEFAULT NULL,
  `04_stop_drinking_after_two_drinks` enum('never', 'rarely', 'sometimes', 'often', 'always', 'skip') DEFAULT NULL,
  `04_stop_drinking_after_drunk` enum('never', 'rarely', 'sometimes', 'often', 'always', 'skip') DEFAULT NULL,
  `04_irresistible_urge_continue_drinking` enum('never', 'rarely', 'sometimes', 'often', 'always', 'skip') DEFAULT NULL,
  `04_difficult_to_resist_drinking` enum('never', 'rarely', 'sometimes', 'often', 'always', 'skip') DEFAULT NULL,
  `04_able_to_slow_drinking` enum('never', 'rarely', 'sometimes', 'often', 'always', 'skip') DEFAULT NULL,
  `05_embarassing_things` enum('no','yes','skip') DEFAULT NULL,
  `05_hangover` enum('no','yes','skip') DEFAULT NULL,
  `05_sick` enum('no','yes','skip') DEFAULT NULL,
  `05_end_up_drinking_without_planning` enum('no','yes','skip') DEFAULT NULL,
  `05_take_foolish_risks` enum('no','yes','skip') DEFAULT NULL,
  `05_pass_out` enum('no','yes','skip') DEFAULT NULL,
  `05_need_larger_amounts_to_feel_effect` enum('no','yes','skip') DEFAULT NULL,
  `05_impulsive_things` enum('no','yes','skip') DEFAULT NULL,
  `05_memory_loss` enum('no','yes','skip') DEFAULT NULL,
  `05_drive_unsafely` enum('no','yes','skip') DEFAULT NULL,
  `05_miss_work_or_class` enum('no','yes','skip') DEFAULT NULL,
  `05_regretted_sexual_situations` enum('no','yes','skip') DEFAULT NULL,
  `05_difficult_to_limit` enum('no','yes','skip') DEFAULT NULL,
  `05_become_rude` enum('no','yes','skip') DEFAULT NULL,
  `05_wake_up_unexpected_place` enum('no','yes','skip') DEFAULT NULL,
  `05_feel_bad` enum('no','yes','skip') DEFAULT NULL,
  `05_lack_of_energy` enum('no','yes','skip') DEFAULT NULL,
  `05_suffered_work_quality` enum('no','yes','skip') DEFAULT NULL,
  `05_spend_too_much_time_drinking` enum('no','yes','skip') DEFAULT NULL,
  `05_neglect_obligations` enum('no','yes','skip') DEFAULT NULL,
  `05_relationship_problems` enum('no','yes','skip') DEFAULT NULL,
  `05_overweight` enum('no','yes','skip') DEFAULT NULL,
  `05_harmed_physical_appearance` enum('no','yes','skip') DEFAULT NULL,
  `05_need_drink_before_breakfast` enum('no','yes','skip') DEFAULT NULL,
