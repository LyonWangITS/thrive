	...
	<div class="article-wrap">
		...
		*/
		...
		<article>
			...
			<p>This estimate takes into account your sex, weight, the number of standard drinks consumed and the number of hours over which you reported drinking this amount.</p>
		</article>
